...
{
    [TestFixture]
    public class BucketAvailabilityCheckTests
    {
        private BucketAvailabilityCheck _sut;
        ...
        public void Setup()
        {
            ...
            _sut = new BucketAvailabilityCheck(_httpClientFactoryMock.Object, new CouchbaseClusterSettings
            {
        ...
        {
            Assert.Throws<ArgumentException>(() => new BucketAvailabilityCheck(_httpClientFactoryMock.Object, null));
        }

        [Test]
        public void Constructor_WithEmptySettings_ShouldThrowException()
        {
            Assert.Throws<ArgumentException>(() => new BucketAvailabilityCheck(_httpClientFactoryMock.Object, new CouchbaseBucketSizeSettings()));
        }
