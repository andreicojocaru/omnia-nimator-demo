...
{
    [TestFixture]
    public class ServerAvailabilityCheckTests
    {
        private ServerAvailabilityCheck _sut;
        ...
        public void Setup()
        {
            ...
            _sut = new ServerAvailabilityCheck(_httpClientFactoryMock.Object, new CouchbaseClusterSettings
            {
        ...
        {
            Assert.Throws<ArgumentException>(() => new ServerAvailabilityCheck(_httpClientFactoryMock.Object, null));
        }

        [Test]
        public void Constructor_WithEmptySettings_ShouldThrowException()
        {
            Assert.Throws<ArgumentException>(() => new ServerAvailabilityCheck(_httpClientFactoryMock.Object, new CouchbaseBucketSizeSettings()));
        }
